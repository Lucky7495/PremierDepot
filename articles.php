...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p class="card-price"><?php if($articles[0]["promo"]){echo $articles[0]["prix"]." euros ".'<i class="fa-solid fa-tag"></i>';} else { echo $articles[0]["prix"]." euros";} ?></p>
        <p class="card-text"><?php if(strlen($articles[0]["description"])>100){
            echo substr($articles[0]["description"],0,100)." ...";
        } else{ echo $articles[0]["description"];
        }
         ?></p>
